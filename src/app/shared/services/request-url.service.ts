...
export type URL_KEYS =
  ...
  'login' | 'signup' | 'sendOtp' | 'completeSignup' |
  'forgetPassword' | 'userList' | 'updateProfile' | 'gitRepository'
...
const UrlMapping = {
  ...
  gitRepository: { url: 'https://api.github.com/search/repositories', showMsg: false }
};
